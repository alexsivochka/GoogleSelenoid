...
public class FirefoxDriverProvider implements WebDriverProvider {
    ...
    public WebDriver createDriver(DesiredCapabilities capabilities) {
        ...
        firefoxProfile.setPreference("intl.accept_languages", "uk,ru,en-us,en");
        ...
        System.setProperty("driver.version", FirefoxDriverManager.firefoxdriver().getDownloadedVersion());
